...
/**
 * PlaceholderAPI Expansion для MC-Plugin.
 *
 * <p>Регистрирует все наши плейсхолдеры в PAPI под идентификатором {@code mcplugin}.
 * Если PAPI установлен, внешние плагины (TAB, scoreboard-плагины, Discord-интеграции)
 * могут писать {@code %mcplugin_player_ping%}, {@code %mcplugin_online%},
 * {@code %mcplugin_tps_5m%} и т.д. — и получать те же значения, что видит наш плагин.
 *
 ...
 */
public class MCPluginPlaceholderExpansion extends PlaceholderExpansion {

    @Override
    public @NotNull String getIdentifier() {
        return PlaceholderResolver.getPapiIdentifier(); // "mcplugin"
    }
