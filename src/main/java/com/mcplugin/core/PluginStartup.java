...
import com.mcplugin.config.ConfigGuideManager;
import com.mcplugin.config.ConfigIntegrityValidator;
import com.mcplugin.config.MessagesManager;
import com.mcplugin.maintenance.MaintenanceManager;
...
import com.mcplugin.listener.LuckPermsCommandBlocker;
import com.mcplugin.listener.OpCommandBlocker;
import com.mcplugin.listener.WhitelistCommandBlocker;
import com.mcplugin.util.AuthCommandLogFilter;
...
import com.mcplugin.structure.StructureChunkListener;
...
public class PluginStartup {
    ...
    private void checkJavaVersion() {
        try {
            this.plugin.getClass().getClassLoader().loadClass(
                    "com.mcplugin.core.DatapackInstaller");
    ...
    private void initModuleSystem() {
        ...
        ModuleScanner.autoRegister(mm, plugin, "com/mcplugin/module");
    ...
    private void initPostModuleSystems() {
        ...
        // Custom whitelist
        com.mcplugin.whitelist.WhitelistManager.init(plugin);
        ...
        com.mcplugin.server.AccessListCheckTask.start(plugin);

        // Blacklist
        com.mcplugin.whitelist.BlacklistManager.init(plugin);
        ...
        com.mcplugin.command.PluginReloadCommand.init();
